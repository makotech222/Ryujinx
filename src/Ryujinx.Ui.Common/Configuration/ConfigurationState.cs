    ...
    public class ConfigurationState
    {
        ...
        public class GraphicsSection
        {
            ...
            public GraphicsSection()
            {
                ...
                NormalEmulationSpeed.Event       += static (sender, e) => LogValueChange(sender, e, nameof(NormalEmulationSpeed));
                FastForwardEmulationSpeed                 = new ReactiveObject<decimal>();
                FastForwardEmulationSpeed.Event           += static (sender, e) => LogValueChange(sender, e, nameof(FastForwardEmulationSpeed));
                TurboEmulationSpeed                       = new ReactiveObject<decimal>();
                TurboEmulationSpeed.Event                 += static (sender, e) => LogValueChange(sender, e, nameof(TurboEmulationSpeed));
            }
        }
